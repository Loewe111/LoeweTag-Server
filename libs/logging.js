...
class Logging {
  ...
  debug(msg) {
    if (this.level > 3) {
      //If level is 4, log debug messages
      if (typeof msg == "string") {
        //If message is a string, log it, if not, log it as JSON
  ...
  info(msg) {
    if (this.level > 2) {
      //If level is 4 or 3, log info messages
      if (typeof msg == "string") {
  ...
  warn(msg) {
    if (this.level > 1) {
      //If level is 4, 3, or 2, log warn messages
      if (typeof msg == "string") {
  ...
  error(msg) {
    if (this.level > 0) {
      //If level is 4, 3, 2, or 1, log error messages
      if (typeof msg == "string") {
